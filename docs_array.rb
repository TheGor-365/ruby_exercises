...
puts 'cycle'
array = %w[ a b c d ]
array = array.cycle(3) { |item| pp "#{item} + item" }; puts
...
pp array.index { |item| item == 5 }; puts
...
array.reverse_each { |item| pp "#{item} + #{'w'}" }; puts
